...
public class ExceptionHandler {
    ...
    //API 호출 시 생길 수 있는 Exception 자세하게 다시 정리
    @org.springframework.web.bind.annotation.ExceptionHandler(ApiException.class) // 커스텀 예외
    ...
    @org.springframework.web.bind.annotation.ExceptionHandler(MethodArgumentTypeMismatchException.class) // 메서드 인수의 타입 불일치
    ...
    @org.springframework.web.bind.annotation.ExceptionHandler(MissingServletRequestParameterException.class) // 필수 요청 파라미터 누락
    ...
    @org.springframework.web.bind.annotation.ExceptionHandler(MissingRequestHeaderException.class) // 필수 요청 헤더 누락
    ...
    @org.springframework.web.bind.annotation.ExceptionHandler(HttpMessageNotReadableException.class) // 요청 본문이 읽을 수 없는 경우 (예: JSON 파싱 오류)
    ...
    @org.springframework.web.bind.annotation.ExceptionHandler(Exception.class) // 기타 모든 예외
